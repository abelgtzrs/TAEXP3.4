...
const StyledButton = ({ children, onClick, type = "button", loading = false, className = "", variant = "primary" }) => {
  ...
  const variants = {
    primary:
      "bg-primary hover:from-blue-600 hover:to-primary text-white shadow-lg hover:shadow-xl hover:-translate-y-0.5 focus:ring-primary/50 disabled:from-gray-600 disabled:to-gray-700",
    secondary:

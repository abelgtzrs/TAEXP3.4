// --- FILE: client-admin/src/components/dashboard/SystemStatusWidget.jsx ---
        ...
        {systems.map((system) => (
          <div key={system.name} className="flex items-center justify-between text-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className={`w-2 h-2 rounded-full ${system.color}`} style={{ boxShadow: `0 0 6px ${system.color}` }}></div>
            </div>
          </div>
        ))}
      </div>

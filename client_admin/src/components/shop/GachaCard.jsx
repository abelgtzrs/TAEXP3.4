...
const GachaCard = ({ title, description, cost, currencyName, currencySymbol, onPull, isLoading }) => {
    return (
        ...
        <div className="flex flex-col items-center text-center p-6 rounded-lg border w-full" style={{ background: 'var(--color-surface)', borderColor: 'var(--color-primary)' }}>
            ...
            <div className="mb-4">
                ...
                <span className="ml-2 text-lg text-text-secondary">{currencySymbol} {currencyName}</span>
            </div>
